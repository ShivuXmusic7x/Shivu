...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((18, 18), "LUCKY MUSICS", fill="white", font = font1, align ="right") 
            image4.text((665, 150), "NOW PLAYING", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
